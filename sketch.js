...
function setup() {
  ...
  //Botón para comenzar
  button = createImg('startBttn.png');
  button.position(280,250);
  button.size(160,160);
  button.mouseClicked(start1);
...
function draw() {
  ...
  if(gameState === 0){
    ...
    textSize(45);
    fill("#FF0000");
    text("Consigue 100 monedas",120,50);
    text("para convertirte en un ROCKSTAR",60,110);
    text("Click to start",220,220);
